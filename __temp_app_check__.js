    ...
    function obterDescricaoPokemon(especie) {
      ...
      const entrada = idiomasPrioritarios
        ...
        .find(Boolean);
      const texto = entrada?.flavor_text || "Descri��o n�o dispon�vel.";
    ...
    async function traduzirComGoogleGratuito(texto, idiomaOrigem = "auto", idiomaDestino = "pt") {
      ...
      if (!Array.isArray(dadosTraducao) || !Array.isArray(dadosTraducao[0])) {
        throw new Error("Resposta de tradu��o inv�lida.");
      }
    ...
    async function traduzirTextoParaPortugues(texto, idiomaOrigem = "auto") {
      ...
      try {
        ...
        if (!resposta.ok) {
          throw new Error("Falha no servi�o de tradu��o padr�o.");
        }
    ...
    async function selecionarPokemon(nome, registrarHistorico = true) {
      ...
      try {
        ...
        if (
          descricaoOriginal.texto !== "Descri��o n�o dispon�vel." &&
        ...
        document.getElementById("resultado").innerHTML = `
          ...
          <div class="abas-resultado" role="tablist" aria-label="Alternar entre informa��es e cartas TCG">
            <button type="button" class="aba-resultado ativa" data-aba="informacoes" role="tab" aria-selected="true" onclick="alternarAbaResultado('informacoes')">Informa��es</button>
        ...
        document.getElementById("resultado").innerHTML = "? Pok�mon n�o encontrado!";
      }
    }
    ...
    function alternarModo(modo) {
      ...
      if (modo === "pokemon") {
        ...
        // Limpar campos e sugest�es de pacote
    ...
    async function buscarPacotesTcgSugestoes(consulta) {
      ...
      try {
        ...
        // Identificar termos cruzados para buscar em inglês ou português simultaneamente
    ...
    function renderizarPacoteResultado({ set, cartas }, nomePacote) {
      ...
      // Armazenar estado global para navega��o
